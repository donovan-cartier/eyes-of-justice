...
@onready var balloon: ColorRect = $BG
@onready var margin: MarginContainer = $BG/Margin
@onready var character_label: RichTextLabel = $BG/Margin/VBox/Speaker
@onready var dialogue_label := $BG/Margin/VBox/DialogueLabel
@onready var responses_menu: VBoxContainer = $BG/Margin/VBox/Responses
